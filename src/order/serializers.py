...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        self.fields["brand"] = serializers.CharField(source="brand.name")
    ...
    def get_service_type(self, instance):
        return getattr(instance.brand.service_type, f"name_{get_language()}")

    def get_service(self, instance):
        return getattr(
            instance.brand.service_type.service, f"name_{get_language()}"
        )
